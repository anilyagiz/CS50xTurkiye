...
import { CS50xTürkiyeSuggestions } from "@repo/ai/prompt/suggestions";
import { CS50xTürkiyePrompt } from "@repo/ai/prompt/system";
  ...
  const stream = createUIMessageStream<MyUIMessage>({
    ...
    execute: async ({ writer }) => {
      ...
      const streamObjectResult = streamObject({
        model: model.languageModel("google-flash"),
        system: CS50xTürkiyeSuggestions(),
