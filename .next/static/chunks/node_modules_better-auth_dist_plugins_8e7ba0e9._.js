...
"[project]/node_modules/better-auth/dist/plugins/two-factor/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
async function verifyTwoFactor(ctx) {
    ...
    if (!session) {
        ...
        return {
            valid: async (ctx2)=>{
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(ctx2, {
                    session: session2,
                    user
                });
                if (ctx2.body.trustDevice) {
                    ...
                    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hmac$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHMAC"])("SHA-256", "base64urlnopad").sign(ctx2.context.secret, "".concat(user.id, "!").concat(session2.token));
                    await ctx2.setSignedCookie(trustDeviceCookie.name, "".concat(token, "!").concat(session2.token), ctx2.context.secret, trustDeviceCookie.attributes);
    ...
    return {
        ...
        session,
        key: "".concat(session.user.id, "!").concat(session.session.id)
    };
}
function generateBackupCodesFn(options) {
    var _options_amount;
    return Array.from({
        length: (_options_amount = options === null || options === void 0 ? void 0 : options.amount) !== null && _options_amount !== void 0 ? _options_amount : 10
    }).fill(null).map(()=>{
        var _options_length;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])((_options_length = options === null || options === void 0 ? void 0 : options.length) !== null && _options_length !== void 0 ? _options_length : 10, "a-z", "0-9", "A-Z");
    }).map((code)=>"".concat(code.slice(0, 5), "-").concat(code.slice(5)));
}
async function generateBackupCodes(secret, options) {
    const key = secret;
    const backupCodes = (options === null || options === void 0 ? void 0 : options.customBackupCodesGenerate) ? options.customBackupCodesGenerate() : generateBackupCodesFn(options);
    const encCodes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricEncrypt"])({
...
async function getBackupCodes(backupCodes, key) {
    const secret = new TextDecoder("utf-8").decode(new TextEncoder().encode(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricDecrypt"])({
        key,
        data: backupCodes
    })));
    const data = JSON.parse(secret);
    const result = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["array"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]()).safeParse(data);
    if (result.success) {
        return result.data;
    }
    return null;
...
const backupCode2fa = (options)=>{
    ...
    async function storeBackupCodes(ctx, backupCodes) {
        if ((options === null || options === void 0 ? void 0 : options.storeBackupCodes) === "encrypted") {
        ...
        if (typeof (options === null || options === void 0 ? void 0 : options.storeBackupCodes) === "object" && "encrypt" in (options === null || options === void 0 ? void 0 : options.storeBackupCodes)) {
            return await (options === null || options === void 0 ? void 0 : options.storeBackupCodes.encrypt(backupCodes));
        }
        return backupCodes;
    }
    async function decryptBackupCodes(ctx, backupCodes) {
        ...
        if (typeof (options === null || options === void 0 ? void 0 : options.storeBackupCodes) === "object" && "decrypt" in (options === null || options === void 0 ? void 0 : options.storeBackupCodes)) {
            return await (options === null || options === void 0 ? void 0 : options.storeBackupCodes.decrypt(backupCodes));
        }
        return backupCodes;
    }
    return {
       ...
       */ verifyBackupCode: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/verify-backup-code", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: 'A backup code to verify. Eg: "123456"'
                    }),
                    /**
             * Disable setting the session cookie
             */ disableSession: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"]().meta({
             ...
             */ trustDevice: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"]().meta({
                ...
                var _session_session, _session_user;
                ...
                const updatedBackupCodes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricEncrypt"])({
                    key: ctx.context.secret,
                ...
                return ctx.json({
                    token: (_session_session = session.session) === null || _session_session === void 0 ? void 0 : _session_session.token,
                    user: {
                        id: (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.id,
                        email: session.user.email,
                        emailVerified: session.user.emailVerified,
                        name: session.user.name,
                        image: session.user.image,
       ...
       */ generateBackupCodes: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/generate-backup-codes", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
       ...
       */ viewBackupCodes: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/view-backup-codes", {
                method: "GET",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
...
const defaultKeyHasher = async (token)=>{
    const hash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hash$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHash"])("SHA-256").digest(new TextEncoder().encode(token));
...
const otp2fa = (options)=>{
    const opts = {
        ...
        digits: 6,
        ...options,
        period: ((options === null || options === void 0 ? void 0 : options.period) || 3) * 60 * 1e3
    };
    ...
    const send2FaOTP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/send-otp", {
        method: "POST",
        body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
            /**
         * if true, the device will be trusted
         * for 30 days. It'll be refreshed on
         * every sign in request within this time.
         */ trustDevice: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"]().optional().meta({
                description: "If true, the device will be trusted for 30 days. It'll be refreshed on every sign in request within this time. Eg: true"
            })
        }).optional(),
        metadata: {
        ...
        const code = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.digits, "0-9");
        const hashedCode = await storeOTP(ctx, code);
        await ctx.context.internalAdapter.createVerificationValue({
            value: "".concat(hashedCode, ":0"),
            identifier: "2fa-otp-".concat(key),
    ...
    const verifyOTP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/verify-otp", {
        method: "POST",
        body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
            code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
        ...
        var _toCheckOtp_value;
        const { session, key, valid, invalid } = await verifyTwoFactor(ctx);
        const toCheckOtp = await ctx.context.internalAdapter.findVerificationValue("2fa-otp-".concat(key));
        var _toCheckOtp_value_split;
        const [otp, counter] = (_toCheckOtp_value_split = toCheckOtp === null || toCheckOtp === void 0 ? void 0 : (_toCheckOtp_value = toCheckOtp.value) === null || _toCheckOtp_value === void 0 ? void 0 : _toCheckOtp_value.split(":")) !== null && _toCheckOtp_value_split !== void 0 ? _toCheckOtp_value_split : [];
        ...
        const allowedAttempts = (options === null || options === void 0 ? void 0 : options.allowedAttempts) || 5;
        ...
        if (decryptedOtp === ctx.body.code) {
            ...
            await ctx.context.internalAdapter.updateVerificationValue(toCheckOtp.id, {
                value: "".concat(otp, ":").concat((parseInt(counter, 10) || 0) + 1)
            });
...
const totp2fa = (options)=>{
    const opts = {
        ...options,
        digits: (options === null || options === void 0 ? void 0 : options.digits) || 6,
        period: (options === null || options === void 0 ? void 0 : options.period) || 30
    };
    const twoFactorTable = "twoFactor";
    const generateTOTP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/totp/generate", {
        method: "POST",
        body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
            secret: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
        ...
        const code = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$otp$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOTP"])(ctx.body.secret, {
            period: opts.period,
            digits: opts.digits
        }).totp();
        return {
    ...
    const getTOTPURI = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/get-totp-uri", {
        method: "POST",
        use: [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"]
        ],
        ...
        const secret = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricDecrypt"])({
            key: ctx.context.secret,
            data: twoFactor.secret
        });
        await ctx.context.password.checkPassword(user.id, ctx);
        const totpURI = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$otp$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOTP"])(secret, {
            digits: opts.digits,
            period: opts.period
        }).url((options === null || options === void 0 ? void 0 : options.issuer) || ctx.context.appName, user.email);
        return {
            totpURI
        };
    });
    const verifyTOTP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/verify-totp", {
        method: "POST",
        body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
            code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                description: 'The otp code to verify. Eg: "012345"'
        ...
        const decrypted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricDecrypt"])({
            key: ctx.context.secret,
            data: twoFactor.secret
        });
        const status = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$otp$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOTP"])(decrypted, {
            period: opts.period,
            digits: opts.digits
...
const twoFactor = (options)=>{
    ...
    const totp = totp2fa(options === null || options === void 0 ? void 0 : options.totpOptions);
    const backupCode = backupCode2fa(options === null || options === void 0 ? void 0 : options.backupCodeOptions);
    const otp = otp2fa(options === null || options === void 0 ? void 0 : options.otpOptions);
    return {
        id: "two-factor",
        endpoints: {
            ...totp.endpoints,
       ...
       */ enableTwoFactor: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/enable", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "User password"
                    }),
                    issuer: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                var _options_totpOptions, _options_totpOptions1;
                const user = ctx.context.session.user;
                const { password, issuer } = ctx.body;
                const isPasswordValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$YwDQhoPc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"])(ctx, {
                    password,
                    userId: user.id
                });
                if (!isPasswordValid) {
                ...
                const secret = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(32);
                const encryptedSecret = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricEncrypt"])({
                    key: ctx.context.secret,
                    data: secret
                });
                const backupCodes = await generateBackupCodes(ctx.context.secret, options === null || options === void 0 ? void 0 : options.backupCodeOptions);
                if (options === null || options === void 0 ? void 0 : options.skipVerificationOnEnable) {
                    const updatedUser = await ctx.context.internalAdapter.updateUser(user.id, {
                        twoFactorEnabled: true
                    }, ctx);
                ...
                const totpURI = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$otp$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOTP"])(secret, {
                    digits: (options === null || options === void 0 ? void 0 : (_options_totpOptions = options.totpOptions) === null || _options_totpOptions === void 0 ? void 0 : _options_totpOptions.digits) || 6,
                    period: options === null || options === void 0 ? void 0 : (_options_totpOptions1 = options.totpOptions) === null || _options_totpOptions1 === void 0 ? void 0 : _options_totpOptions1.period
                }).url(issuer || (options === null || options === void 0 ? void 0 : options.issuer) || ctx.context.appName, user.email);
                return ctx.json({
                    totpURI,
                    backupCodes: backupCodes.backupCodes
                });
       ...
       */ disableTwoFactor: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/two-factor/disable", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "User password"
            ...
            after: [
                {
                    ...
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        var _options_otpOptions;
                        const data = ctx.context.newSession;
                        if (!data) {
                            return;
                        }
                        if (!(data === null || data === void 0 ? void 0 : data.user.twoFactorEnabled)) {
                            return;
                        }
                        ...
                        if (trustDeviceCookie) {
                            ...
                            const expectedToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hmac$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHMAC"])("SHA-256", "base64urlnopad").sign(ctx.context.secret, "".concat(data.user.id, "!").concat(sessionToken));
                            if (token === expectedToken) {
                                const newToken = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hmac$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHMAC"])("SHA-256", "base64urlnopad").sign(ctx.context.secret, "".concat(data.user.id, "!").concat(sessionToken));
                                await ctx.setSignedCookie(trustDeviceCookieName.name, "".concat(newToken, "!").concat(data.session.token), ctx.context.secret, trustDeviceCookieName.attributes);
                                return;
                            }
                        }
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["d"])(ctx, true);
                        await ctx.context.internalAdapter.deleteSession(data.session.token);
                        var _options_otpOptions_period;
                        const maxAge = ((_options_otpOptions_period = options === null || options === void 0 ? void 0 : (_options_otpOptions = options.otpOptions) === null || _options_otpOptions === void 0 ? void 0 : _options_otpOptions.period) !== null && _options_otpOptions_period !== void 0 ? _options_otpOptions_period : 3) * 60;
                        const twoFactorCookie = ctx.context.createAuthCookie(TWO_FACTOR_COOKIE_NAME, {
                            maxAge
                        });
                        const identifier = "2fa-".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(20));
                        await ctx.context.internalAdapter.createVerificationValue({
                            value: data.user.id,
                            identifier,
...
"[project]/node_modules/better-auth/dist/plugins/username/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const username = (options)=>{
    const normalizer = (username2)=>{
        if ((options === null || options === void 0 ? void 0 : options.usernameNormalization) === false) {
            return username2;
        }
        if (options === null || options === void 0 ? void 0 : options.usernameNormalization) {
    ...
    const displayUsernameNormalizer = (displayUsername)=>{
        return (options === null || options === void 0 ? void 0 : options.displayUsernameNormalization) ? options.displayUsernameNormalization(displayUsername) : displayUsername;
    };
    return {
        id: "username",
        init (ctx) {
        ...
        endpoints: {
            signInUsername: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-in/username", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                var _options_validationOrder, _ctx_context_options_emailAndPassword;
                ...
                const username2 = (options === null || options === void 0 ? void 0 : (_options_validationOrder = options.validationOrder) === null || _options_validationOrder === void 0 ? void 0 : _options_validationOrder.username) === "pre-normalization" ? normalizer(ctx.body.username) : ctx.body.username;
                const minUsernameLength = (options === null || options === void 0 ? void 0 : options.minUsernameLength) || 3;
                const maxUsernameLength = (options === null || options === void 0 ? void 0 : options.maxUsernameLength) || 30;
                ...
                const validator = (options === null || options === void 0 ? void 0 : options.usernameValidator) || defaultUsernameValidator;
                ...
                if (!user.emailVerified && ((_ctx_context_options_emailAndPassword = ctx.context.options.emailAndPassword) === null || _ctx_context_options_emailAndPassword === void 0 ? void 0 : _ctx_context_options_emailAndPassword.requireEmailVerification)) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["T"])(ctx, user);
                ...
                const currentPassword = account === null || account === void 0 ? void 0 : account.password;
                if (!currentPassword) {
            ...
            isUsernameAvailable: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/is-username-available", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
        ...
        schema: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dcv8PS7T$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(getSchema({
            username: normalizer,
            displayUsername: displayUsernameNormalizer
        }), options === null || options === void 0 ? void 0 : options.schema),
        hooks: {
            before: [
                {
                    matcher (context) {
                    ...
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        var _options_validationOrder, _options_validationOrder1;
                        const username2 = typeof ctx.body.username === "string" && (options === null || options === void 0 ? void 0 : (_options_validationOrder = options.validationOrder) === null || _options_validationOrder === void 0 ? void 0 : _options_validationOrder.username) === "post-normalization" ? normalizer(ctx.body.username) : ctx.body.username;
                        ...
                        const displayUsername = typeof ctx.body.displayUsername === "string" && (options === null || options === void 0 ? void 0 : (_options_validationOrder1 = options.validationOrder) === null || _options_validationOrder1 === void 0 ? void 0 : _options_validationOrder1.displayUsername) === "post-normalization" ? displayUsernameNormalizer(ctx.body.displayUsername) : ctx.body.displayUsername;
                        if (displayUsername !== void 0 && typeof displayUsername === "string") {
                            if (options === null || options === void 0 ? void 0 : options.displayUsernameValidator) {
...
"[project]/node_modules/better-auth/dist/plugins/bearer/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            before: [
                {
                    matcher (context) {
                        ...
                        return Boolean(((_context_request = context.request) === null || _context_request === void 0 ? void 0 : _context_request.headers.get("authorization")) || ((_context_headers = context.headers) === null || _context_headers === void 0 ? void 0 : _context_headers.get("authorization")));
                    },
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (c)=>{
                        var _c_request_headers_get, _c_request, _c_headers_get, _c_headers, _c_request1;
                        const token = ((_c_request = c.request) === null || _c_request === void 0 ? void 0 : (_c_request_headers_get = _c_request.headers.get("authorization")) === null || _c_request_headers_get === void 0 ? void 0 : _c_request_headers_get.replace("Bearer ", "")) || ((_c_headers = c.headers) === null || _c_headers === void 0 ? void 0 : (_c_headers_get = _c_headers.get("Authorization")) === null || _c_headers_get === void 0 ? void 0 : _c_headers_get.replace("Bearer ", ""));
                        if (!token) {
                            return;
                        }
                        let signedToken = "";
                        if (token.includes(".")) {
                            ...
                            if (options === null || options === void 0 ? void 0 : options.requireSignature) {
                                return;
                            }
                            signedToken = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serializeSignedCookie"])("", token, c.context.secret)).replace("=", "");
                        }
                        try {
                            const decodedToken = decodeURIComponent(signedToken);
                            const isValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hmac$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHMAC"])("SHA-256", "base64urlnopad").verify(c.context.secret, decodedToken.split(".")[0], decodedToken.split(".")[1]);
                            if (!isValid) {
                                return;
                            }
                        } catch (e) {
                        ...
                        const existingHeaders = ((_c_request1 = c.request) === null || _c_request1 === void 0 ? void 0 : _c_request1.headers) || c.headers;
                        const headers = new Headers({
                            ...Object.fromEntries(existingHeaders === null || existingHeaders === void 0 ? void 0 : existingHeaders.entries())
                        });
                        headers.append("cookie", "".concat(c.context.authCookies.sessionToken.name, "=").concat(signedToken));
                        return {
                            context: {
                                headers
                            }
            ...
            after: [
                {
                    ...
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        ...
                        const parsedCookies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"])(setCookie);
                        ...
                        const exposedHeaders = ((_ctx_context_responseHeaders1 = ctx.context.responseHeaders) === null || _ctx_context_responseHeaders1 === void 0 ? void 0 : _ctx_context_responseHeaders1.get("access-control-expose-headers")) || "";
...
"[project]/node_modules/better-auth/dist/plugins/magic-link/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const defaultKeyHasher = async (otp)=>{
    const hash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hash$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHash"])("SHA-256").digest(new TextEncoder().encode(otp));
    const hashed = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$base64$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["base64Url"].encode(new Uint8Array(hash), {
        padding: false
    });
    return hashed;
...
const magicLink = (options)=>{
    var _opts_rateLimit, _opts_rateLimit1;
    const opts = {
        storeToken: "plain",
        ...options
    };
    ...
    return {
       ...
       */ signInMagicLink: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-in/magic-link", {
                method: "POST",
                requireHeaders: true,
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    ...
                    newUserCallbackURL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                const verificationToken = (opts === null || opts === void 0 ? void 0 : opts.generateToken) ? await opts.generateToken(email) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(32, "a-z", "A-Z");
                ...
                const url = new URL("".concat(pathname).concat(basePath, "/magic-link/verify"), realBaseURL.origin);
       ...
       */ magicLinkVerify: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/magic-link/verify", {
                method: "GET",
                ...
                use: [
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"])((ctx)=>{
                ...
                (callbackURL === null || callbackURL === void 0 ? void 0 : callbackURL.startsWith("http")) ? callbackURL : callbackURL ? "".concat(ctx.context.options.baseURL).concat(callbackURL) : ctx.context.options.baseURL;
                const storedToken = await storeToken(ctx, token);
                const tokenValue = await ctx.context.internalAdapter.findVerificationValue(storedToken);
                if (!tokenValue) {
                    throw ctx.redirect("".concat(errorCallbackURL, "?error=INVALID_TOKEN"));
                }
                if (tokenValue.expiresAt < /* @__PURE__ */ new Date()) {
                    await ctx.context.internalAdapter.deleteVerificationValue(tokenValue.id);
                    throw ctx.redirect("".concat(errorCallbackURL, "?error=EXPIRED_TOKEN"));
                }
                await ctx.context.internalAdapter.deleteVerificationValue(tokenValue.id);
                const { email, name } = JSON.parse(tokenValue.value);
                let isNewUser = false;
                let user = await ctx.context.internalAdapter.findUserByEmail(email).then((res)=>res === null || res === void 0 ? void 0 : res.user);
                if (!user) {
                    if (!opts.disableSignUp) {
                        ...
                        user = newUser;
                        if (!user) {
                            throw ctx.redirect("".concat(errorCallbackURL, "?error=failed_to_create_user"));
                        }
                    } else {
                        throw ctx.redirect("".concat(errorCallbackURL, "?error=new_user_signup_disabled"));
                    }
                }
                ...
                if (!session) {
                    throw ctx.redirect("".concat(errorCallbackURL, "?error=failed_to_create_session"));
                }
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(ctx, {
                    session,
                    user
        ...
        rateLimit: [
            {
                ...
                window: ((_opts_rateLimit = opts.rateLimit) === null || _opts_rateLimit === void 0 ? void 0 : _opts_rateLimit.window) || 60,
                max: ((_opts_rateLimit1 = opts.rateLimit) === null || _opts_rateLimit1 === void 0 ? void 0 : _opts_rateLimit1.max) || 5
            }
        ]
    };
};
...
"[project]/node_modules/better-auth/dist/plugins/phone-number/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateOTP(size) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(size, "0-9");
}
const phoneNumber = (options)=>{
    const opts = {
        expiresIn: (options === null || options === void 0 ? void 0 : options.expiresIn) || 300,
        otpLength: (options === null || options === void 0 ? void 0 : options.otpLength) || 6,
        ...options,
    ...
    return {
       ...
       */ signInPhoneNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-in/phone-number", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    phoneNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                if (opts.requireVerification) {
                    if (!user.phoneNumberVerified) {
                        ...
                        await ctx.context.internalAdapter.createVerificationValue({
                            ...
                            expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.expiresIn, "sec")
                        }, ctx);
                        await ((_opts_sendOTP = opts.sendOTP) === null || _opts_sendOTP === void 0 ? void 0 : _opts_sendOTP.call(opts, {
       ...
       */ sendPhoneNumberOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/phone-number/send-otp", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    phoneNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                if (!(options === null || options === void 0 ? void 0 : options.sendOTP)) {
       ...
       */ verifyPhoneNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/phone-number/verify", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    /**
             * Phone number
             ...
             * phone number
             */ updatePhoneNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"]().meta({
                ...
                var _options_callbackOnVerification;
                ...
                const allowedAttempts = (options === null || options === void 0 ? void 0 : options.allowedAttempts) || 3;
                ...
                if (otpValue !== ctx.body.code) {
                    await ctx.context.internalAdapter.updateVerificationValue(otp.id, {
                        value: "".concat(otpValue, ":").concat(parseInt(attempts || "0") + 1)
                    });
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: "Invalid OTP"
                    });
                ...
                if (!user) {
                    if (options === null || options === void 0 ? void 0 : options.signUpOnVerification) {
                        ...
                        if (!user) {
                            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("INTERNAL_SERVER_ERROR", {
                                message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"].FAILED_TO_CREATE_USER
                            });
                        }
                    }
                } else {
                ...
                if (!user) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("INTERNAL_SERVER_ERROR", {
                        message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"].FAILED_TO_UPDATE_USER
                    });
                }
                await (options === null || options === void 0 ? void 0 : (_options_callbackOnVerification = options.callbackOnVerification) === null || _options_callbackOnVerification === void 0 ? void 0 : _options_callbackOnVerification.call(options, {
                    phoneNumber: ctx.body.phoneNumber,
                    user
                }, ctx.request));
                if (!ctx.body.disableSession) {
       ...
       */ forgetPasswordPhoneNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/phone-number/forget-password", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    phoneNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                var _options_sendForgetPasswordOTP;
                const user = await ctx.context.adapter.findOne({
                    model: "user",
                    where: [
                        {
                ...
                await ctx.context.internalAdapter.createVerificationValue({
                    value: "".concat(code, ":0"),
                    identifier: "".concat(ctx.body.phoneNumber, "-request-password-reset"),
                    expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.expiresIn, "sec")
                }, ctx);
                await (options === null || options === void 0 ? void 0 : (_options_sendForgetPasswordOTP = options.sendForgetPasswordOTP) === null || _options_sendForgetPasswordOTP === void 0 ? void 0 : _options_sendForgetPasswordOTP.call(options, {
                    phoneNumber: ctx.body.phoneNumber,
                    code
                }, ctx.request));
                return ctx.json({
            ...
            requestPasswordResetPhoneNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/phone-number/request-password-reset", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    phoneNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]()
                }),
                metadata: {
                    openapi: {
                        description: "Request OTP for password reset via phone number",
                ...
                var _options_sendPasswordResetOTP;
                const user = await ctx.context.adapter.findOne({
                    model: "user",
                    where: [
                        {
                ...
                await (options === null || options === void 0 ? void 0 : (_options_sendPasswordResetOTP = options.sendPasswordResetOTP) === null || _options_sendPasswordResetOTP === void 0 ? void 0 : _options_sendPasswordResetOTP.call(options, {
                    phoneNumber: ctx.body.phoneNumber,
                    code
                }, ctx.request));
                return ctx.json({
            ...
            resetPasswordPhoneNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/phone-number/reset-password", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    otp: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                const verification = await ctx.context.internalAdapter.findVerificationValue("".concat(ctx.body.phoneNumber, "-request-password-reset"));
                if (!verification) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: ERROR_CODES.OTP_NOT_FOUND
                    });
...
"[project]/node_modules/better-auth/dist/plugins/anonymous/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const anonymous = (options)=>{
    ...
    return {
        id: "anonymous",
        endpoints: {
            signInAnonymous: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-in/anonymous", {
                method: "POST",
                metadata: {
                    openapi: {
                ...
                var _options_generateName;
                const { emailDomainName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CuS_eDdK$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx.context.baseURL) } = options || {};
                const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$BUPPRXfK$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])();
                const email = "temp-".concat(id, "@").concat(emailDomainName);
                const name = await (options === null || options === void 0 ? void 0 : (_options_generateName = options.generateName) === null || _options_generateName === void 0 ? void 0 : _options_generateName.call(options, ctx)) || "Anonymous";
                const newUser = await ctx.context.internalAdapter.createUser({
                    email,
                    emailVerified: false,
                    isAnonymous: true,
            ...
            after: [
                {
                    ...
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        var _ctx_context_responseHeaders, _parseSetCookieHeader_get;
                        const setCookie = (_ctx_context_responseHeaders = ctx.context.responseHeaders) === null || _ctx_context_responseHeaders === void 0 ? void 0 : _ctx_context_responseHeaders.get("set-cookie");
                        const sessionTokenName = ctx.context.authCookies.sessionToken.name;
                        const sessionCookie = (_parseSetCookieHeader_get = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"])(setCookie || "").get(sessionTokenName)) === null || _parseSetCookieHeader_get === void 0 ? void 0 : _parseSetCookieHeader_get.value.split(".")[0];
                        if (!sessionCookie) {
                            return;
                        }
                        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx, {
                        ...
                        if (options === null || options === void 0 ? void 0 : options.onLinkAccount) {
                            var _options_onLinkAccount;
                            await (options === null || options === void 0 ? void 0 : (_options_onLinkAccount = options.onLinkAccount) === null || _options_onLinkAccount === void 0 ? void 0 : _options_onLinkAccount.call(options, {
                                anonymousUser: session,
                                newUser: newSession
                            }));
                        }
                        if (!(options === null || options === void 0 ? void 0 : options.disableDeleteAnonymousUser)) {
...
"[project]/node_modules/better-auth/dist/plugins/generic-oauth/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getUserInfo(tokens, finalUserInfoUrl) {
    var _userInfo_data, _userInfo_data1, _userInfo_data2, _userInfo_data3, _userInfo_data4;
    if (tokens.idToken) {
        const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$util$2f$decode_jwt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeJwt"])(tokens.idToken);
        if (decoded) {
    ...
    const userInfo = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(finalUserInfoUrl, {
        method: "GET",
        headers: {
            Authorization: "Bearer ".concat(tokens.accessToken)
        }
    });
    var _userInfo_data_email_verified;
    return {
        // @ts-expect-error sub is optional in the type
        id: (_userInfo_data = userInfo.data) === null || _userInfo_data === void 0 ? void 0 : _userInfo_data.sub,
        emailVerified: (_userInfo_data_email_verified = (_userInfo_data1 = userInfo.data) === null || _userInfo_data1 === void 0 ? void 0 : _userInfo_data1.email_verified) !== null && _userInfo_data_email_verified !== void 0 ? _userInfo_data_email_verified : false,
        email: (_userInfo_data2 = userInfo.data) === null || _userInfo_data2 === void 0 ? void 0 : _userInfo_data2.email,
        image: (_userInfo_data3 = userInfo.data) === null || _userInfo_data3 === void 0 ? void 0 : _userInfo_data3.picture,
        name: (_userInfo_data4 = userInfo.data) === null || _userInfo_data4 === void 0 ? void 0 : _userInfo_data4.name,
        ...userInfo.data
    };
}
const genericOAuth = (options)=>{
    ...
    return {
            ...
            const genericProviders = options.config.map((c)=>{
                ...
                return {
                    ...
                    createAuthorizationURL (data) {
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])({
                            id: c.providerId,
                            options: {
                                clientId: c.clientId,
                            ...
                            scopes: c.scopes || [],
                            redirectURI: "".concat(ctx.baseURL, "/oauth2/callback/").concat(c.providerId)
                        });
                    },
                    async validateAuthorizationCode (data) {
                        let finalTokenUrl = c.tokenUrl;
                        if (c.discoveryUrl) {
                            const discovery = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(c.discoveryUrl, {
                                method: "GET",
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"])({
                    ...
                    async refreshAccessToken (refreshToken) {
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["r"])({
                            refreshToken,
                            options: {
                                clientId: c.clientId,
                                clientSecret: c.clientSecret
                    ...
                    async getUserInfo (tokens) {
                        ...
                        return {
                            user: {
                                ...
                                emailVerified: userInfo === null || userInfo === void 0 ? void 0 : userInfo.emailVerified,
                                image: userInfo === null || userInfo === void 0 ? void 0 : userInfo.image,
                                name: userInfo === null || userInfo === void 0 ? void 0 : userInfo.name,
                                ...(_c_mapProfileToUser = c.mapProfileToUser) === null || _c_mapProfileToUser === void 0 ? void 0 : _c_mapProfileToUser.call(c, userInfo)
                            },
                            data: userInfo
                        };
                    }
       ...
       */ signInWithOAuth2: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-in/oauth2", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                ...
                if (!config) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: "No config found for provider ".concat(providerId)
                    });
                }
                ...
                if (discoveryUrl) {
                    const discovery = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(discoveryUrl, {
                        method: "GET",
                ...
                const { state, codeVerifier } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx);
                const authUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])({
                    id: providerId,
                    options: {
                        clientId,
                        redirectURI
                    ...
                    redirectURI: "".concat(ctx.context.baseURL, "/oauth2/callback/").concat(providerId),
                    prompt,
                    accessType,
                    responseType,
                    responseMode,
            ...
            oAuth2Callback: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/oauth2/callback/:providerId", {
                method: "GET",
                query: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "The OAuth2 code"
                    }).optional(),
                    error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "The error message, if any"
                    }).optional(),
                    error_description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "The error description, if any"
                    }).optional(),
                    state: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                var _ctx_context_options_onAPIError, _tokens_scopes;
                const defaultErrorURL = ((_ctx_context_options_onAPIError = ctx.context.options.onAPIError) === null || _ctx_context_options_onAPIError === void 0 ? void 0 : _ctx_context_options_onAPIError.errorURL) || "".concat(ctx.context.baseURL, "/error");
                if (ctx.query.error || !ctx.query.code) {
                    throw ctx.redirect("".concat(defaultErrorURL, "?error=").concat(ctx.query.error || "oAuth_code_missing", "&error_description=").concat(ctx.query.error_description));
                }
                const provider = options.config.find((p)=>p.providerId === ctx.params.providerId);
                if (!provider) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: "No config found for provider ".concat(ctx.params.providerId)
                    });
                }
                let tokens = void 0;
                const parsedState = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"])(ctx);
                ...
                function redirectOnError(error) {
                    ...
                    const defaultErrorURL2 = ((_ctx_context_options_onAPIError = ctx.context.options.onAPIError) === null || _ctx_context_options_onAPIError === void 0 ? void 0 : _ctx_context_options_onAPIError.errorURL) || "".concat(ctx.context.baseURL, "/error");
                    let url = errorURL || defaultErrorURL2;
                    if (url.includes("?")) {
                        url = "".concat(url, "&error=").concat(error);
                    } else {
                        url = "".concat(url, "?error=").concat(error);
                    }
                ...
                if (provider.discoveryUrl) {
                    const discovery = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(provider.discoveryUrl, {
                        method: "GET",
                ...
                try {
                    ...
                    tokens = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["v"])({
                        headers: provider.authorizationHeaders,
                        code,
                        codeVerifier: provider.pkce ? codeVerifier : void 0,
                        redirectURI: "".concat(ctx.context.baseURL, "/oauth2/callback/").concat(provider.providerId),
                        options: {
                ...
                const userInfo = await async function handleUserInfo() {
                    ...
                    const email = mapUser.email ? mapUser.email.toLowerCase() : (_userInfo2_email = userInfo2.email) === null || _userInfo2_email === void 0 ? void 0 : _userInfo2_email.toLowerCase();
                    if (!email) {
                ...
                if (link) {
                    ...
                    if (((_ctx_context_options_account = ctx.context.options.account) === null || _ctx_context_options_account === void 0 ? void 0 : (_ctx_context_options_account_accountLinking = _ctx_context_options_account.accountLinking) === null || _ctx_context_options_account_accountLinking === void 0 ? void 0 : _ctx_context_options_account_accountLinking.allowDifferentEmails) !== true && link.email !== userInfo.email) {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["j"])(ctx, {
                    userInfo,
                    account: {
                        providerId: provider.providerId,
                        accountId: userInfo.id,
       ...
       */ oAuth2LinkAccount: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/oauth2/link", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
             ...
             */ errorCallbackURL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                const state = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(c, {
                    userId: session.user.id,
                    email: session.user.email
                });
                const url = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])({
                    id: providerId,
                    options: {
                        clientId,
                        redirectURI: redirectURI || "".concat(c.context.baseURL, "/oauth2/callback/").concat(providerId)
                    },
                    authorizationEndpoint: finalAuthUrl,
                    state: state.state,
...
"[project]/node_modules/better-auth/dist/plugins/jwt/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$binary$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@better-auth/utils/dist/binary.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dcv8PS7T$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.Dcv8PS7T.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/crypto/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hash$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@better-auth/utils/dist/hash.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@better-auth/utils/dist/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@better-auth/utils/dist/hex.mjs [app-client] (ecmascript)");
...
const jwt = (options)=>{
    var _options_jwt, _options_jwks, _options_jwks1, _options_jwks_keyPairConfig, _options_jwks2;
    if ((options === null || options === void 0 ? void 0 : (_options_jwt = options.jwt) === null || _options_jwt === void 0 ? void 0 : _options_jwt.sign) && !((_options_jwks = options.jwks) === null || _options_jwks === void 0 ? void 0 : _options_jwks.remoteUrl)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DdzSJf$2d$n$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"]("jwks_config", "jwks.remoteUrl must be set when using jwt.sign");
    }
    if ((options === null || options === void 0 ? void 0 : (_options_jwks1 = options.jwks) === null || _options_jwks1 === void 0 ? void 0 : _options_jwks1.remoteUrl) && !((_options_jwks2 = options.jwks) === null || _options_jwks2 === void 0 ? void 0 : (_options_jwks_keyPairConfig = _options_jwks2.keyPairConfig) === null || _options_jwks_keyPairConfig === void 0 ? void 0 : _options_jwks_keyPairConfig.alg)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DdzSJf$2d$n$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["B"]("jwks_config", "must specify alg when using the oidc plugin and jwks.remoteUrl");
    }
    return {
        id: "jwt",
        options,
        endpoints: {
            getJwks: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/jwks", {
                method: "GET",
                metadata: {
                    openapi: {
                ...
                var _options_jwks, _options_jwks1;
                if (options === null || options === void 0 ? void 0 : (_options_jwks = options.jwks) === null || _options_jwks === void 0 ? void 0 : _options_jwks.remoteUrl) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("NOT_FOUND");
                }
                const adapter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CY7$2d$Inqt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(ctx.context.adapter);
                const keySets = await adapter.getAllKeys();
                if (keySets.length === 0) {
                    const key = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CY7$2d$Inqt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(ctx, options);
                    keySets.push(key);
                }
                const keyPairConfig = options === null || options === void 0 ? void 0 : (_options_jwks1 = options.jwks) === null || _options_jwks1 === void 0 ? void 0 : _options_jwks1.keyPairConfig;
                const defaultCrv = keyPairConfig ? "crv" in keyPairConfig ? keyPairConfig.crv : void 0 : void 0;
                return ctx.json({
                    keys: keySets.map((keySet)=>{
                        var _options_jwks_keyPairConfig, _options_jwks;
                        var _keySet_alg, _ref, _keySet_crv;
                        return {
                            alg: (_ref = (_keySet_alg = keySet.alg) !== null && _keySet_alg !== void 0 ? _keySet_alg : options === null || options === void 0 ? void 0 : (_options_jwks = options.jwks) === null || _options_jwks === void 0 ? void 0 : (_options_jwks_keyPairConfig = _options_jwks.keyPairConfig) === null || _options_jwks_keyPairConfig === void 0 ? void 0 : _options_jwks_keyPairConfig.alg) !== null && _ref !== void 0 ? _ref : "EdDSA",
                            crv: (_keySet_crv = keySet.crv) !== null && _keySet_crv !== void 0 ? _keySet_crv : defaultCrv,
            ...
            getToken: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/token", {
                method: "GET",
                requireHeaders: true,
                use: [
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"]
                ...
                const jwt2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CY7$2d$Inqt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx, options);
                return ctx.json({
                    token: jwt2
                });
            }),
            signJWT: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-jwt", {
                method: "POST",
                metadata: {
                    SERVER_ONLY: true,
                    $Infer: {
                ...
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].object({
                    payload: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].record(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string(), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].any()),
                    overrideOptions: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].record(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].string(), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].any()).optional()
                })
            }, async (c)=>{
                const jwt2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CY7$2d$Inqt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(c, {
                    options: {
                        ...options,
            ...
            after: [
                {
                    ...
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        if (options === null || options === void 0 ? void 0 : options.disableSettingJwtHeader) {
                            return;
                        }
                        ...
                        if (session && session.session) {
                            ...
                            const jwt2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CY7$2d$Inqt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx, options);
                            const exposedHeaders = ((_ctx_context_responseHeaders = ctx.context.responseHeaders) === null || _ctx_context_responseHeaders === void 0 ? void 0 : _ctx_context_responseHeaders.get("access-control-expose-headers")) || "";
                            const headersSet = new Set(exposedHeaders.split(",").map((header)=>header.trim()).filter(Boolean));
...
"[project]/node_modules/better-auth/dist/plugins/multi-session/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const multiSession = (options)=>{
    ...
    return {
       ...
       */ listDeviceSessions: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/multi-session/list-device-sessions", {
                method: "GET",
                requireHeaders: true
            }, async (ctx)=>{
                var _ctx_headers;
                const cookieHeader = (_ctx_headers = ctx.headers) === null || _ctx_headers === void 0 ? void 0 : _ctx_headers.get("cookie");
                if (!cookieHeader) return ctx.json([]);
                const cookies = Object.fromEntries((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(cookieHeader));
                const sessionTokens = (await Promise.all(Object.entries(cookies).filter((param)=>{
                    let [key] = param;
                    return isMultiSessionCookie(key);
                }).map(async (param)=>{
                    let [key] = param;
                    return await ctx.getSignedCookie(key, ctx.context.secret);
                }))).filter((v)=>v !== null);
       ...
       */ setActiveSession: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/multi-session/set-active", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                ...
                const multiSessionCookieName = "".concat(ctx.context.authCookies.sessionToken.name, "_multi-").concat(sessionToken.toLowerCase());
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(ctx, session);
       ...
       */ revokeDeviceSession: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/multi-session/revoke", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    sessionToken: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                var _ctx_context_session, _ctx_headers;
                const sessionToken = ctx.body.sessionToken;
                const multiSessionCookieName = "".concat(ctx.context.authCookies.sessionToken.name, "_multi-").concat(sessionToken.toLowerCase());
                const sessionCookie = await ctx.getSignedCookie(multiSessionCookieName, ctx.context.secret);
                if (!sessionCookie) {
                ...
                const isActive = ((_ctx_context_session = ctx.context.session) === null || _ctx_context_session === void 0 ? void 0 : _ctx_context_session.session.token) === sessionToken;
                ...
                if (cookieHeader) {
                    ...
                    if (sessionTokens.length > 0) {
                        ...
                        if (validSessions.length > 0) {
                            ...
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"])(ctx, nextSession);
                        } else {
            ...
            after: [
                {
                    matcher: ()=>true,
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        var _ctx_context_responseHeaders, _ctx_context_newSession, _ctx_headers;
                        const cookieString = (_ctx_context_responseHeaders = ctx.context.responseHeaders) === null || _ctx_context_responseHeaders === void 0 ? void 0 : _ctx_context_responseHeaders.get("set-cookie");
                        if (!cookieString) return;
                        const setCookies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p"])(cookieString);
                        const sessionCookieConfig = ctx.context.authCookies.sessionToken;
                        const sessionToken = (_ctx_context_newSession = ctx.context.newSession) === null || _ctx_context_newSession === void 0 ? void 0 : _ctx_context_newSession.session.token;
                        if (!sessionToken) return;
                        const cookies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(((_ctx_headers = ctx.headers) === null || _ctx_headers === void 0 ? void 0 : _ctx_headers.get("cookie")) || "");
                        const cookieName = "".concat(sessionCookieConfig.name, "_multi-").concat(sessionToken.toLowerCase());
...
"[project]/node_modules/better-auth/dist/plugins/email-otp/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const emailOTP = (options)=>{
    const opts = {
        expiresIn: 5 * 60,
        generateOTP: ()=>{
            var _options_otpLength;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])((_options_otpLength = options.otpLength) !== null && _options_otpLength !== void 0 ? _options_otpLength : 6, "0-9");
        },
        storeOTP: "plain",
        ...options
    };
     ...
     */ sendVerificationOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/email-otp/send-verification-otp", {
            method: "POST",
            body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]({}).meta({
                    description: "Email address to send the OTP"
                }),
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enum"](types).meta({
            ...
            if (!(options === null || options === void 0 ? void 0 : options.sendVerificationOTP)) {
            ...
            await ctx.context.internalAdapter.createVerificationValue({
                value: "".concat(storedOTP, ":0"),
                identifier: "".concat(ctx.body.type, "-otp-").concat(email),
                expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.expiresIn, "sec")
            }, ctx).catch(async (error)=>{
                await ctx.context.internalAdapter.deleteVerificationByIdentifier("".concat(ctx.body.type, "-otp-").concat(email));
                await ctx.context.internalAdapter.createVerificationValue({
                    value: "".concat(storedOTP, ":0"),
                    identifier: "".concat(ctx.body.type, "-otp-").concat(email),
                    expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.expiresIn, "sec")
    ...
    return {
        ...
        endpoints: {
            ...endpoints,
            createVerificationOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/email-otp/create-verification-otp", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]({}).meta({
                        description: "Email address to send the OTP"
       ...
       */ getVerificationOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/email-otp/get-verification-otp", {
                method: "GET",
                query: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]({}).meta({
                ...
                const verificationValue = await ctx.context.internalAdapter.findVerificationValue("".concat(ctx.query.type, "-otp-").concat(email));
                ...
                let otp = storedOtp;
                if (opts.storeOTP === "encrypted") {
                    otp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricDecrypt"])({
                        key: ctx.context.secret,
                        data: storedOtp
                    });
                }
       ...
       */ checkVerificationOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/email-otp/check-verification-otp", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "Email address the OTP was sent to"
                ...
                const verificationValue = await ctx.context.internalAdapter.findVerificationValue("".concat(ctx.body.type, "-otp-").concat(email));
       ...
       */ verifyEmailOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/email-otp/verify-email", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]({}).meta({
                ...
                var _ctx_context_options_emailVerification_onEmailVerification, _ctx_context_options_emailVerification, _ctx_context_options_emailVerification1;
                const email = ctx.body.email;
                if (!emailRegex.test(email)) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: ERROR_CODES.INVALID_EMAIL
                ...
                const verificationValue = await ctx.context.internalAdapter.findVerificationValue("email-verification-otp-".concat(email));
                if (!verificationValue) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: ERROR_CODES.INVALID_OTP
                    });
                ...
                await ((_ctx_context_options_emailVerification = ctx.context.options.emailVerification) === null || _ctx_context_options_emailVerification === void 0 ? void 0 : (_ctx_context_options_emailVerification_onEmailVerification = _ctx_context_options_emailVerification.onEmailVerification) === null || _ctx_context_options_emailVerification_onEmailVerification === void 0 ? void 0 : _ctx_context_options_emailVerification_onEmailVerification.call(_ctx_context_options_emailVerification, updatedUser, ctx.request));
                if ((_ctx_context_options_emailVerification1 = ctx.context.options.emailVerification) === null || _ctx_context_options_emailVerification1 === void 0 ? void 0 : _ctx_context_options_emailVerification1.autoSignInAfterVerification) {
       ...
       */ signInEmailOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/sign-in/email-otp", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]({}).meta({
                ...
                const email = ctx.body.email;
                const verificationValue = await ctx.context.internalAdapter.findVerificationValue("sign-in-otp-".concat(email));
                if (!verificationValue) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: ERROR_CODES.INVALID_OTP
                    });
       ...
       */ forgetPasswordEmailOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/forget-password/email-otp", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "Email address to send the OTP"
                ...
                await ctx.context.internalAdapter.createVerificationValue({
                    value: "".concat(storedOTP, ":0"),
                    identifier: "forget-password-otp-".concat(email),
                    expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.expiresIn, "sec")
                }, ctx);
                await options.sendVerificationOTP({
                    email,
       ...
       */ resetPasswordEmailOTP: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/email-otp/reset-password", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                const verificationValue = await ctx.context.internalAdapter.findVerificationValue("forget-password-otp-".concat(email));
                if (!verificationValue) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                        message: ERROR_CODES.INVALID_OTP
                    });
            ...
            after: [
                {
                    matcher (context) {
                        var _context_path;
                        return !!(((_context_path = context.path) === null || _context_path === void 0 ? void 0 : _context_path.startsWith("/sign-up")) && opts.sendVerificationOnSignUp);
                    },
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        ...
                        const email = response === null || response === void 0 ? void 0 : response.user.email;
                        if (email) {
                            const otp = opts.generateOTP({
                                email,
                                type: ctx.body.type
                            ...
                            await ctx.context.internalAdapter.createVerificationValue({
                                value: "".concat(storedOTP, ":0"),
                                identifier: "email-verification-otp-".concat(email),
                                expiresAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(opts.expiresIn, "sec")
                            }, ctx);
                            await options.sendVerificationOTP({
                                email,
...
"[project]/node_modules/better-auth/dist/plugins/one-tap/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const oneTap = (options)=>({
        id: "one-tap",
        endpoints: {
            oneTapCallback: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/one-tap/callback", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    idToken: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                ...
                let payload;
                try {
                    var _ctx_context_options_socialProviders_google, _ctx_context_options_socialProviders;
                    const JWKS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$jwks$2f$remote$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRemoteJWKSet"])(new URL("https://www.googleapis.com/oauth2/v3/certs"));
                    const { payload: verifiedPayload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$jwt$2f$verify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jwtVerify"])(idToken, JWKS, {
                        issuer: [
                            "https://accounts.google.com",
                            "accounts.google.com"
                        ],
                        audience: (options === null || options === void 0 ? void 0 : options.clientId) || ((_ctx_context_options_socialProviders = ctx.context.options.socialProviders) === null || _ctx_context_options_socialProviders === void 0 ? void 0 : (_ctx_context_options_socialProviders_google = _ctx_context_options_socialProviders.google) === null || _ctx_context_options_socialProviders_google === void 0 ? void 0 : _ctx_context_options_socialProviders_google.clientId)
                    });
                ...
                const user = await ctx.context.internalAdapter.findUserByEmail(email);
                if (!user) {
                    if (options === null || options === void 0 ? void 0 : options.disableSignup) {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_GATEWAY", {
                ...
                if (!account) {
                    var _ctx_context_options_account, _accountLinking_trustedProviders;
                    const accountLinking = (_ctx_context_options_account = ctx.context.options.account) === null || _ctx_context_options_account === void 0 ? void 0 : _ctx_context_options_account.accountLinking;
                    const shouldLinkAccount = (accountLinking === null || accountLinking === void 0 ? void 0 : accountLinking.enabled) && (((_accountLinking_trustedProviders = accountLinking.trustedProviders) === null || _accountLinking_trustedProviders === void 0 ? void 0 : _accountLinking_trustedProviders.includes("google")) || email_verified);
...
"[project]/node_modules/better-auth/dist/plugins/oauth-proxy/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getVenderBaseURL() {
    const vercel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].VERCEL_URL ? "https://".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].VERCEL_URL) : void 0;
    const netlify = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].NETLIFY_URL;
    const render = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].RENDER_URL;
    const aws = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].AWS_LAMBDA_FUNCTION_NAME;
    const google = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].GOOGLE_CLOUD_FUNCTION_NAME;
    const azure = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].AZURE_FUNCTION_NAME;
    return vercel || netlify || render || aws || google || azure;
}
const oAuthProxy = (opts)=>{
    const resolveCurrentURL = (ctx)=>{
        var _ctx_request;
        return new URL((opts === null || opts === void 0 ? void 0 : opts.currentURL) || ((_ctx_request = ctx.request) === null || _ctx_request === void 0 ? void 0 : _ctx_request.url) || getVenderBaseURL() || ctx.context.baseURL);
    };
    return {
        id: "oauth-proxy",
        endpoints: {
            oAuthProxy: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/oauth-proxy-callback", {
                method: "GET",
                query: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    callbackURL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "The URL to redirect to after the proxy"
                    }),
                    cookies: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().meta({
                        description: "The cookies to set after the proxy"
                    })
                }),
                use: [
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"])((ctx)=>ctx.query.callbackURL)
                ],
                metadata: {
                    openapi: {
                ...
                var _ctx_context_options_onAPIError, _ctx_context_options_advanced;
                const cookies = ctx.query.cookies;
                const decryptedCookies = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricDecrypt"])({
                    key: ctx.context.secret,
                    data: cookies
                }).catch((e)=>{
                ...
                const error = ((_ctx_context_options_onAPIError = ctx.context.options.onAPIError) === null || _ctx_context_options_onAPIError === void 0 ? void 0 : _ctx_context_options_onAPIError.errorURL) || "".concat(ctx.context.options.baseURL, "/api/auth/error");
                if (!decryptedCookies) {
                    throw ctx.redirect("".concat(error, "?error=OAuthProxy - Invalid cookies or secret"));
                }
                const isSecureContext = resolveCurrentURL(ctx).protocol === "https:";
                const prefix = ((_ctx_context_options_advanced = ctx.context.options.advanced) === null || _ctx_context_options_advanced === void 0 ? void 0 : _ctx_context_options_advanced.cookiePrefix) || "better-auth";
                const cookieToSet = isSecureContext ? decryptedCookies : decryptedCookies.replace("Secure;", "").replace("__Secure-".concat(prefix), prefix);
        ...
        hooks: {
            after: [
                {
                    matcher (context) {
                        var _context_path, _context_path1;
                        return ((_context_path = context.path) === null || _context_path === void 0 ? void 0 : _context_path.startsWith("/callback")) || ((_context_path1 = context.path) === null || _context_path1 === void 0 ? void 0 : _context_path1.startsWith("/oauth2/callback"));
                    },
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        const headers = ctx.context.responseHeaders;
                        const location = headers === null || headers === void 0 ? void 0 : headers.get("location");
                        if (location === null || location === void 0 ? void 0 : location.includes("/oauth-proxy-callback?callbackURL")) {
                            if (!location.startsWith("http")) {
                                return;
                            }
                            const locationURL = new URL(location);
                            const origin = locationURL.origin;
                            if (origin === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CuS_eDdK$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx.context.baseURL)) {
                            ...
                            const setCookies = headers === null || headers === void 0 ? void 0 : headers.get("set-cookie");
                            if (!setCookies) {
                                return;
                            }
                            const encryptedCookies = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$crypto$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["symmetricEncrypt"])({
                                key: ctx.context.secret,
                                data: setCookies
                            });
                            const locationWithCookies = "".concat(location, "&cookies=").concat(encodeURIComponent(encryptedCookies));
            ...
            before: [
                {
                    matcher (context) {
                        var _context_path, _context_path1;
                        return ((_context_path = context.path) === null || _context_path === void 0 ? void 0 : _context_path.startsWith("/sign-in/social")) || ((_context_path1 = context.path) === null || _context_path1 === void 0 ? void 0 : _context_path1.startsWith("/sign-in/oauth2"));
                    },
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        var _ctx_request;
                        const skipProxy = (_ctx_request = ctx.request) === null || _ctx_request === void 0 ? void 0 : _ctx_request.headers.get("x-skip-oauth-proxy");
                        if (skipProxy) {
                            return;
                        }
                        const url = resolveCurrentURL(ctx);
                        const productionURL = (opts === null || opts === void 0 ? void 0 : opts.productionURL) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["e"].BETTER_AUTH_URL;
                        if (productionURL === ctx.context.options.baseURL) {
                            return;
                        }
                        ctx.body.callbackURL = "".concat(url.origin).concat(ctx.context.options.basePath || "/api/auth", "/oauth-proxy-callback?callbackURL=").concat(encodeURIComponent(ctx.body.callbackURL || ctx.context.baseURL));
                        return {
                            context: ctx
                        };
                    })
...
"[project]/node_modules/better-auth/dist/plugins/custom-session/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getSessionQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["optional"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
     ...
     */ disableCookieCache: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"]().meta({
        description: "Disable cookie cache and fetch session from database"
    }).or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().transform((v)=>v === "true")).optional(),
    disableRefresh: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["boolean"]().meta({
    ...
    return {
        ...
        hooks: {
            after: [
                {
                    matcher: (ctx)=>{
                        var _pluginOptions_shouldMutateListDeviceSessionsEndpoint;
                        return ctx.path === "/multi-session/list-device-sessions" && ((_pluginOptions_shouldMutateListDeviceSessionsEndpoint = pluginOptions === null || pluginOptions === void 0 ? void 0 : pluginOptions.shouldMutateListDeviceSessionsEndpoint) !== null && _pluginOptions_shouldMutateListDeviceSessionsEndpoint !== void 0 ? _pluginOptions_shouldMutateListDeviceSessionsEndpoint : false);
                    },
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DQI8AD7d$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx);
                        if (!response) return;
        ...
        endpoints: {
            getSession: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/get-session", {
                method: "GET",
                ...
                const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b"])()({
                    ...ctx,
                    asResponse: false,
                    headers: ctx.headers,
                    returnHeaders: true
...
"[project]/node_modules/better-auth/dist/plugins/open-api/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/v4/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/v4/classic/schemas.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/v4/classic/index.js [app-client] (ecmascript)");
...
function getParameters(options) {
    ...
    if (options.query instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodObject"]) {
        Object.entries(options.query.shape).forEach((param)=>{
            let [key, value] = param;
            if (value instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodType"]) {
                parameters.push({
                    name: key,
                    in: "query",
                    schema: {
...
function getRequestBody(options) {
    ...
    if (options.body instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodObject"] || options.body instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodOptional"]) {
        ...
        Object.entries(shape).forEach((param)=>{
            ...
            if (value instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodType"]) {
                ...
                if (!(value instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].ZodOptional)) {
                    required.push(key);
                }
            }
        });
        return {
            required: options.body instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ZodOptional"] ? false : options.body ? true : false,
            content: {
                "application/json": {
                    schema: {
                        type: "object",
...
function toOpenApiPath(path) {
    return path.split("/").map((part)=>part.startsWith(":") ? "{".concat(part.slice(1), "}") : part).join("/");
}
async function generator(ctx, options) {
    const baseEndpoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEndpoints"])(ctx, {
        ...options,
        plugins: []
    });
    ...
    const models = Object.entries(tables).reduce((acc, param)=>{
        let [key, value] = param;
    ...
    const paths = {};
    Object.entries(baseEndpoints.api).forEach((param)=>{
        let [_, value] = param;
        var _ctx_options_disabledPaths, _options2_metadata;
        if ((_ctx_options_disabledPaths = ctx.options.disabledPaths) === null || _ctx_options_disabledPaths === void 0 ? void 0 : _ctx_options_disabledPaths.includes(value.path)) return;
        const options2 = value.options;
        if ((_options2_metadata = options2.metadata) === null || _options2_metadata === void 0 ? void 0 : _options2_metadata.SERVER_ONLY) return;
        const path = toOpenApiPath(value.path);
        if (options2.method === "GET") {
            var _options2_metadata_openapi, _options2_metadata1, _options2_metadata_openapi1, _options2_metadata2, _options2_metadata_openapi2, _options2_metadata3, _options2_metadata_openapi3, _options2_metadata4;
            paths[path] = {
                get: {
                    tags: [
                        "Default",
                        ...((_options2_metadata1 = options2.metadata) === null || _options2_metadata1 === void 0 ? void 0 : (_options2_metadata_openapi = _options2_metadata1.openapi) === null || _options2_metadata_openapi === void 0 ? void 0 : _options2_metadata_openapi.tags) || []
                    ],
                    description: (_options2_metadata2 = options2.metadata) === null || _options2_metadata2 === void 0 ? void 0 : (_options2_metadata_openapi1 = _options2_metadata2.openapi) === null || _options2_metadata_openapi1 === void 0 ? void 0 : _options2_metadata_openapi1.description,
                    operationId: (_options2_metadata3 = options2.metadata) === null || _options2_metadata3 === void 0 ? void 0 : (_options2_metadata_openapi2 = _options2_metadata3.openapi) === null || _options2_metadata_openapi2 === void 0 ? void 0 : _options2_metadata_openapi2.operationId,
                    security: [
                        {
                            bearerAuth: []
                        }
                    ...
                    responses: getResponse((_options2_metadata4 = options2.metadata) === null || _options2_metadata4 === void 0 ? void 0 : (_options2_metadata_openapi3 = _options2_metadata4.openapi) === null || _options2_metadata_openapi3 === void 0 ? void 0 : _options2_metadata_openapi3.responses)
                }
            };
        }
        if (options2.method === "POST") {
            var _options2_metadata_openapi4, _options2_metadata5, _options2_metadata_openapi5, _options2_metadata6, _options2_metadata_openapi6, _options2_metadata7, _options2_metadata_openapi7, _options2_metadata8;
            const body = getRequestBody(options2);
            paths[path] = {
                post: {
                    tags: [
                        "Default",
                        ...((_options2_metadata5 = options2.metadata) === null || _options2_metadata5 === void 0 ? void 0 : (_options2_metadata_openapi4 = _options2_metadata5.openapi) === null || _options2_metadata_openapi4 === void 0 ? void 0 : _options2_metadata_openapi4.tags) || []
                    ],
                    description: (_options2_metadata6 = options2.metadata) === null || _options2_metadata6 === void 0 ? void 0 : (_options2_metadata_openapi5 = _options2_metadata6.openapi) === null || _options2_metadata_openapi5 === void 0 ? void 0 : _options2_metadata_openapi5.description,
                    operationId: (_options2_metadata7 = options2.metadata) === null || _options2_metadata7 === void 0 ? void 0 : (_options2_metadata_openapi6 = _options2_metadata7.openapi) === null || _options2_metadata_openapi6 === void 0 ? void 0 : _options2_metadata_openapi6.operationId,
                    security: [
                        {
                            bearerAuth: []
                        }
                    ...
                    responses: getResponse((_options2_metadata8 = options2.metadata) === null || _options2_metadata8 === void 0 ? void 0 : (_options2_metadata_openapi7 = _options2_metadata8.openapi) === null || _options2_metadata_openapi7 === void 0 ? void 0 : _options2_metadata_openapi7.responses)
                }
            };
        }
    });
    for (const plugin of options.plugins || []){
        ...
        const pluginEndpoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$api$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getEndpoints"])(ctx, {
            ...options,
            plugins: [
                plugin
            ]
        ...
        Object.entries(api).forEach((param)=>{
            let [key, value] = param;
            var _ctx_options_disabledPaths, _options2_metadata;
            if ((_ctx_options_disabledPaths = ctx.options.disabledPaths) === null || _ctx_options_disabledPaths === void 0 ? void 0 : _ctx_options_disabledPaths.includes(value.path)) return;
            const options2 = value.options;
            ...
            if (options2.method === "GET") {
                ...
                paths[path] = {
                    get: {
                        tags: ((_options2_metadata1 = options2.metadata) === null || _options2_metadata1 === void 0 ? void 0 : (_options2_metadata_openapi = _options2_metadata1.openapi) === null || _options2_metadata_openapi === void 0 ? void 0 : _options2_metadata_openapi.tags) || [
            ...
            if (options2.method === "POST") {
                ...
                paths[path] = {
                    post: {
                        tags: ((_options2_metadata5 = options2.metadata) === null || _options2_metadata5 === void 0 ? void 0 : (_options2_metadata_openapi4 = _options2_metadata5.openapi) === null || _options2_metadata_openapi4 === void 0 ? void 0 : _options2_metadata_openapi4.tags) || [
                            plugin.id.charAt(0).toUpperCase() + plugin.id.slice(1)
                        ],
                        description: (_options2_metadata6 = options2.metadata) === null || _options2_metadata6 === void 0 ? void 0 : (_options2_metadata_openapi5 = _options2_metadata6.openapi) === null || _options2_metadata_openapi5 === void 0 ? void 0 : _options2_metadata_openapi5.description,
                        operationId: (_options2_metadata7 = options2.metadata) === null || _options2_metadata7 === void 0 ? void 0 : (_options2_metadata_openapi6 = _options2_metadata7.openapi) === null || _options2_metadata_openapi6 === void 0 ? void 0 : _options2_metadata_openapi6.operationId,
...
const getHTML = (apiReference, theme)=>'<!doctype html>\n<html>\n  <head>\n    <title>Scalar API Reference</title>\n    <meta charset="utf-8" />\n    <meta\n      name="viewport"\n      content="width=device-width, initial-scale=1" />\n  </head>\n  <body>\n    <script\n      id="api-reference"\n      type="application/json">\n    '.concat(JSON.stringify(apiReference), '\n    </script>\n	 <script>\n      var configuration = {\n	  	favicon: "data:image/svg+xml;utf8,').concat(encodeURIComponent(logo), '",\n	   	theme: "').concat(theme || "default", '",\n        metaData: {\n			title: "Better Auth API",\n			description: "API Reference for your Better Auth Instance",\n		}\n      }\n\n      document.getElementById(\'api-reference\').dataset.configuration =\n        JSON.stringify(configuration)\n    </script>\n	  <script src="https://cdn.jsdelivr.net/npm/@scalar/api-reference"></script>\n  </body>\n</html>');
const openAPI = (options)=>{
    var _options_path;
    const path = (_options_path = options === null || options === void 0 ? void 0 : options.path) !== null && _options_path !== void 0 ? _options_path : "/reference";
    return {
        id: "open-api",
        endpoints: {
            generateOpenAPISchema: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/open-api/generate-schema", {
                method: "GET"
            }, async (ctx)=>{
                const schema = await generator(ctx.context, ctx.context.options);
                return ctx.json(schema);
            }),
            openAPIReference: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(path, {
                method: "GET",
                metadata: {
                    isAction: false
                }
            }, async (ctx)=>{
                if (options === null || options === void 0 ? void 0 : options.disableDefaultReference) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("NOT_FOUND");
                }
                const schema = await generator(ctx.context, ctx.context.options);
                return new Response(getHTML(schema, options === null || options === void 0 ? void 0 : options.theme), {
                    headers: {
...
"[project]/node_modules/better-auth/dist/plugins/captcha/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const middlewareResponse = (param)=>{
    let { message, status } = param;
    return {
...
const cloudflareTurnstile = async (param)=>{
    let { siteVerifyURL, captchaResponse, secretKey, remoteIP } = param;
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(siteVerifyURL, {
        method: "POST",
        headers: {
...
const googleRecaptcha = async (param)=>{
    let { siteVerifyURL, captchaResponse, secretKey, minScore = 0.5, remoteIP } = param;
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(siteVerifyURL, {
        method: "POST",
        headers: {
...
const hCaptcha = async (param)=>{
    let { siteVerifyURL, captchaResponse, secretKey, siteKey, remoteIP } = param;
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])(siteVerifyURL, {
        method: "POST",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded"
...
const captcha = (options)=>({
        ...
        onRequest: async (request, ctx)=>{
            try {
                var _options_endpoints;
                const endpoints = ((_options_endpoints = options.endpoints) === null || _options_endpoints === void 0 ? void 0 : _options_endpoints.length) ? options.endpoints : defaultEndpoints;
                ...
                const remoteUserIP = (_request_headers_get = request.headers.get("x-captcha-user-remote-ip")) !== null && _request_headers_get !== void 0 ? _request_headers_get : void 0;
                if (!captchaResponse) {
                    return middlewareResponse({
                ...
                ctx.logger.error(errorMessage !== null && errorMessage !== void 0 ? errorMessage : "Unknown error", {
...
"[project]/node_modules/better-auth/dist/plugins/device-authorization/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
    ...
    deviceCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"](),
    userCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"](),
    userId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
    ...
    status: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"](),
    lastPolledAt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["date"]().optional(),
    pollingInterval: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["number"]().optional(),
    clientId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
    scope: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional()
});
const msStringValueSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].custom((val)=>{
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(val);
    } catch (e) {
        return false;
    }
    return true;
...
const $deviceAuthorizationOptionsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    deviceCodeLength: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().int().positive().default(40).describe("Length of the device code to be generated. Default is 40 characters."),
    userCodeLength: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].number().int().positive().default(8).describe("Length of the user code to be generated. Default is 8 characters."),
    generateDeviceCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].custom((val)=>typeof val === "function", {
    ...
    generateUserCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].custom((val)=>typeof val === "function", {
    ...
    validateClient: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].custom((val)=>typeof val === "function", {
    ...
    onDeviceAuthRequest: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].custom((val)=>typeof val === "function", {
    ...
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].custom(()=>true)
});
...
const defaultGenerateDeviceCode = (length)=>{
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(length, "a-z", "A-Z", "0-9");
};
const defaultGenerateUserCode = (length)=>{
    const chars = new Uint8Array(length);
    return Array.from((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uncrypto$2f$dist$2f$crypto$2e$web$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRandomValues"])(chars)).map((byte)=>defaultCharset[byte % defaultCharset.length]).join("");
};
const deviceAuthorization = function() {
    ...
    return {
        ...
        schema: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dcv8PS7T$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(schema, options === null || options === void 0 ? void 0 : options.schema),
        endpoints: {
            deviceCode: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/device/code", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
                    client_id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
                        description: "The client ID of the application"
                    }),
                    scope: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
                        description: "Space-separated list of scopes"
                    }).optional()
                }),
                error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
                    error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].enum([
                        "invalid_request",
                        "invalid_client"
                    ]).meta({
                        description: "Error code"
                    }),
                    error_description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
                ...
                const expiresIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(opts.expiresIn);
                ...
                await ctx.context.adapter.create({
                    ...
                    data: {
                        ...
                        expiresAt,
                        status: "pending",
                        pollingInterval: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(opts.interval),
                ...
                return ctx.json({
                    ...
                    interval: Math.floor((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$UfVWArIB$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(opts.interval) / 1e3)
                }, {
                    headers: {
            ...
            deviceToken: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/device/token", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
                    grant_type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].literal("urn:ietf:params:oauth:grant-type:device_code").meta({
                        description: "The grant type for device flow"
                    }),
                    device_code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
                        description: "The device verification code"
                    }),
                    client_id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
                        description: "The client ID of the application"
            ...
            deviceVerify: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/device", {
                method: "GET",
                query: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
                    user_code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
            ...
            deviceApprove: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/device/approve", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
                    userCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
            ...
            deviceDeny: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/device/deny", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
                    userCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().meta({
...
"[project]/node_modules/better-auth/dist/plugins/haveibeenpwned/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkPasswordCompromise(password, customMessage) {
    if (!password) return;
    const sha1Hash = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$hash$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHash"])("SHA-1", "hex").digest(password)).toUpperCase();
    const prefix = sha1Hash.substring(0, 5);
    const suffix = sha1Hash.substring(5);
    try {
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["betterFetch"])("https://api.pwnedpasswords.com/range/".concat(prefix), {
            headers: {
                "Add-Padding": "true",
        ...
        if (error) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("INTERNAL_SERVER_ERROR", {
                message: "Failed to check password. Status: ".concat(error.status)
            });
        }
        ...
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]) throw error;
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("INTERNAL_SERVER_ERROR", {
            ...
            return {
                context: {
                    password: {
                        ...ctx.password,
                        async hash (password) {
                            await checkPasswordCompromise(password, options === null || options === void 0 ? void 0 : options.customPasswordCompromisedMessage);
...
"[project]/node_modules/better-auth/dist/plugins/siwe/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.CMQ3rA-I.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$BjBlybv$2d2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.BjBlybv-.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/v4/classic/external.js [app-client] (ecmascript) <export * as z>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CuS_eDdK$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.CuS_eDdK.mjs [app-client] (ecmascript)");
...
function toChecksumAddress(address) {
    ...
    const hash = [
        ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$hashes$2f$esm$2f$sha3$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["keccak_256"])(address)
...
const siwe = (options)=>({
        ...
        schema: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Dcv8PS7T$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["m"])(schema, options === null || options === void 0 ? void 0 : options.schema),
        endpoints: {
            getSiweNonce: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/siwe/nonce", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
                    walletAddress: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^0[xX][a-fA-F0-9]{40}$/i).length(42),
                    chainId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive().max(2147483647).optional().default(1)
                })
            }, async (ctx)=>{
                ...
                await ctx.context.internalAdapter.createVerificationValue({
                    identifier: "siwe:".concat(walletAddress, ":").concat(chainId),
                    value: nonce,
            ...
            verifySiweMessage: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/siwe/verify", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
                    message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
                    signature: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
                    walletAddress: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^0[xX][a-fA-F0-9]{40}$/i).length(42),
                    chainId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive().max(2147483647).optional().default(1),
                    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().email().optional()
                ...
                const walletAddress = toChecksumAddress(rawWalletAddress);
                var _options_anonymous;
                const isAnon = (_options_anonymous = options.anonymous) !== null && _options_anonymous !== void 0 ? _options_anonymous : true;
                if (!isAnon && !email) {
                    throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APIError"]("BAD_REQUEST", {
                ...
                try {
                    const verification = await ctx.context.internalAdapter.findVerificationValue("siwe:".concat(walletAddress, ":").concat(chainId));
                    ...
                    if (!user) {
                        var _options_ensLookup;
                        var _options_emailDomainName;
                        const domain = (_options_emailDomainName = options.emailDomainName) !== null && _options_emailDomainName !== void 0 ? _options_emailDomainName : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CuS_eDdK$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx.context.baseURL);
                        const userEmail = !isAnon && email ? email : "".concat(walletAddress, "@").concat(domain);
                        var _ref;
                        const { name, avatar } = (_ref = await ((_options_ensLookup = options.ensLookup) === null || _options_ensLookup === void 0 ? void 0 : _options_ensLookup.call(options, {
                            walletAddress
                        }))) !== null && _ref !== void 0 ? _ref : {};
                        user = await ctx.context.internalAdapter.createUser({
                            name: name !== null && name !== void 0 ? name : walletAddress,
                            email: userEmail,
                            image: avatar !== null && avatar !== void 0 ? avatar : ""
                        });
                        await ctx.context.adapter.create({
                            model: "walletAddress",
                            data: {
                        ...
                        await ctx.context.internalAdapter.createAccount({
                            userId: user.id,
                            providerId: "siwe",
                            accountId: "".concat(walletAddress, ":").concat(chainId),
                            createdAt: /* @__PURE__ */ new Date(),
                            updatedAt: /* @__PURE__ */ new Date()
                        });
                    } else {
...
"[project]/node_modules/better-auth/dist/plugins/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$two$2d$factor$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/two-factor/index.mjs [app-client] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.DV5EHeYG.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$nqWf7zUe$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.nqWf7zUe.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$magic$2d$link$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/magic-link/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$phone$2d$number$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/phone-number/index.mjs [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$BA2h5uPw$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.BA2h5uPw.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$generic$2d$oauth$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/generic-oauth/index.mjs [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$multi$2d$session$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/multi-session/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$email$2d$otp$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/email-otp/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$one$2d$tap$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/one-tap/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$oauth$2d$proxy$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/oauth-proxy/index.mjs [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$captcha$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/captcha/index.mjs [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$haveibeenpwned$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/haveibeenpwned/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/v4/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/node_modules/zod/v4/classic/schemas.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-call/dist/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.CMQ3rA-I.mjs [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$plugins$2f$siwe$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/plugins/siwe/index.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$Ddw8bVyV$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.Ddw8bVyV.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CY7$2d$Inqt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.CY7-Inqt.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$BpA03GIs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.BpA03GIs.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CW6D9eSx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/better-auth/dist/shared/better-auth.CW6D9eSx.mjs [app-client] (ecmascript)");
...
async function authorizeMCPOAuth(ctx, options) {
    ...
    if (!session) {
        ...
        throw ctx.redirect("".concat(options.loginPage, "?").concat(queryFromURL));
    }
    const query = ctx.query;
    console.log(query);
    if (!query.client_id) {
        throw ctx.redirect("".concat(ctx.context.baseURL, "/error?error=invalid_client"));
    }
    if (!query.response_type) {
        throw ctx.redirect(redirectErrorURL("".concat(ctx.context.baseURL, "/error"), "invalid_request", "response_type is required"));
    }
    ...
    if (client.disabled) {
        throw ctx.redirect("".concat(ctx.context.baseURL, "/error?error=client_disabled"));
    }
    if (query.response_type !== "code") {
        throw ctx.redirect("".concat(ctx.context.baseURL, "/error?error=unsupported_response_type"));
    }
    ...
    if (invalidScopes.length) {
        throw ctx.redirect(redirectErrorURL(query.redirect_uri, "invalid_scope", "The following scopes are invalid: ".concat(invalidScopes.join(", "))));
    }
...
const getMCPProviderMetadata = (ctx, options)=>{
    ...
    return {
        issuer,
        authorization_endpoint: "".concat(baseURL, "/mcp/authorize"),
        token_endpoint: "".concat(baseURL, "/mcp/token"),
        userinfo_endpoint: "".concat(baseURL, "/mcp/userinfo"),
        jwks_uri: "".concat(baseURL, "/mcp/jwks"),
        registration_endpoint: "".concat(baseURL, "/mcp/register"),
        scopes_supported: [
            "openid",
            "profile",
            "email",
...
const getMCPProtectedResourceMetadata = (ctx, options)=>{
    var _options_metadata, _options_metadata1;
    const baseURL = ctx.context.baseURL;
    var _options_metadata_jwks_uri, _options_metadata_scopes_supported;
    return {
        resource: baseURL,
        authorization_servers: [
            baseURL
        ],
        jwks_uri: (_options_metadata_jwks_uri = options === null || options === void 0 ? void 0 : (_options_metadata = options.metadata) === null || _options_metadata === void 0 ? void 0 : _options_metadata.jwks_uri) !== null && _options_metadata_jwks_uri !== void 0 ? _options_metadata_jwks_uri : "".concat(baseURL, "/mcp/jwks"),
        scopes_supported: (_options_metadata_scopes_supported = options === null || options === void 0 ? void 0 : (_options_metadata1 = options.metadata) === null || _options_metadata1 === void 0 ? void 0 : _options_metadata1.scopes_supported) !== null && _options_metadata_scopes_supported !== void 0 ? _options_metadata_scopes_supported : [
            "openid",
            "profile",
            "email",
            "offline_access"
...
const mcp = (options)=>{
    ...
    const opts = {
        ...
        scopes: [
            ...
            "email",
            "offline_access",
            ...((_options_oidcConfig = options.oidcConfig) === null || _options_oidcConfig === void 0 ? void 0 : _options_oidcConfig.scopes) || []
        ]
    };
    const modelName = {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DIVj9vPt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["o"])(opts);
    return {
        id: "mcp",
        hooks: {
            after: [
        ...
        endpoints: {
            getMcpOAuthConfig: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/.well-known/oauth-authorization-server", {
                method: "GET",
                metadata: {
                    client: false
                }
            ...
            getMCPProtectedResource: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/.well-known/oauth-protected-resource", {
                method: "GET",
                metadata: {
                    client: false
                }
            ...
            mcpOAuthAuthroize: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/mcp/authorize", {
                method: "GET",
            ...
            mcpOAuthToken: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/mcp/token", {
                method: "POST",
                ...
                let secretKey = {
                    alg: "HS256",
                    key: await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uncrypto$2f$dist$2f$crypto$2e$web$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subtle"].generateKey({
                        name: "HMAC",
                        hash: "SHA-256"
                    }, true, [
                        "sign",
                ...
                const idToken = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$jwt$2f$sign$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SignJWT"]({
                    sub: user.id,
            ...
            registerMcpClient: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/mcp/register", {
                method: "POST",
                body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
                    ...
                    client_name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    client_uri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    logo_uri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    scope: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    ...
                    tos_uri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    policy_uri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    jwks_uri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    jwks: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["record"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"](), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["any"]()).optional(),
                    metadata: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["record"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["any"](), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["any"]()).optional(),
                    software_id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    software_version: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional(),
                    software_statement: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().optional()
                }),
                metadata: {
                    openapi: {
                ...
                var _ctx_headers, _opts_generateClientId, _opts_generateClientSecret;
                const body = ctx.body;
                const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(ctx);
                ctx.setHeader("Access-Control-Allow-Origin", "*");
                ctx.setHeader("Access-Control-Allow-Methods", "POST, OPTIONS");
                ctx.setHeader("Access-Control-Allow-Headers", "Content-Type, Authorization");
                ctx.setHeader("Access-Control-Max-Age", "86400");
                (_ctx_headers = ctx.headers) === null || _ctx_headers === void 0 ? void 0 : _ctx_headers.set("Access-Control-Max-Age", "86400");
                ...
                const clientId = ((_opts_generateClientId = opts.generateClientId) === null || _opts_generateClientId === void 0 ? void 0 : _opts_generateClientId.call(opts)) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(32, "a-z", "A-Z");
                const clientSecret = ((_opts_generateClientSecret = opts.generateClientSecret) === null || _opts_generateClientSecret === void 0 ? void 0 : _opts_generateClientSecret.call(opts)) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$B4Qoxdgc$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(32, "a-z", "A-Z");
            ...
            getMcpSession: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])("/mcp/get-session", {
                method: "GET",
                requireHeaders: true
            }, async (c)=>{
                var _c_headers_get, _c_headers;
                const accessToken = (_c_headers = c.headers) === null || _c_headers === void 0 ? void 0 : (_c_headers_get = _c_headers.get("Authorization")) === null || _c_headers_get === void 0 ? void 0 : _c_headers_get.replace("Bearer ", "");
                if (!accessToken) {
                    var _c_headers1;
                    (_c_headers1 = c.headers) === null || _c_headers1 === void 0 ? void 0 : _c_headers1.set("WWW-Authenticate", "Bearer");
                    return c.json(null);
                }
        ...
        schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DIVj9vPt$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["s"]
    };
};
const withMcpAuth = (auth, handler)=>{
    return async (req)=>{
        const baseURL = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CuS_eDdK$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"])(auth.options.baseURL, auth.options.basePath);
        if (!baseURL && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$CMQ3rA$2d$I$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"]) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$BjBlybv$2d2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["a"].warn("Unable to get the baseURL, please check your config!");
        }
        const session = await auth.api.getMcpSession({
            headers: req.headers
        });
        const wwwAuthenticateValue = "Bearer resource_metadata=".concat(baseURL, "/api/auth/.well-known/oauth-protected-resource");
        if (!session) {
...
const lastLoginMethod = (userConfig)=>{
    var _config_schema_user, _config_schema;
    const paths = [
        "/callback/:id",
        "/oauth2/callback/:id",
        "/sign-in/email",
    ...
    const config = {
        ...
        customResolveMethod: (ctx)=>{
            if (paths.includes(ctx.path)) {
                var _ctx_params;
                return ((_ctx_params = ctx.params) === null || _ctx_params === void 0 ? void 0 : _ctx_params.id) ? ctx.params.id : ctx.path.split("/").pop();
            }
            return null;
        },
        ...userConfig
            ...
            after: [
                {
                    ...
                    handler: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$auth$2f$dist$2f$shared$2f$better$2d$auth$2e$DV5EHeYG$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(async (ctx)=>{
                        ...
                        lastUsedLoginMethod && ctx.setCookie(config.cookieName, lastUsedLoginMethod, {
            ...
            user: {
                fields: {
                    lastLoginMethod: {
                        ...
                        input: false,
                        required: false,
                        fieldName: ((_config_schema = config.schema) === null || _config_schema === void 0 ? void 0 : (_config_schema_user = _config_schema.user) === null || _config_schema_user === void 0 ? void 0 : _config_schema_user.lastLoginMethod) || "lastLoginMethod"
                    }
                }
            }
        } : void 0
...
//# sourceMappingURL=node_modules_better-auth_dist_plugins_8e7ba0e9._.js.map