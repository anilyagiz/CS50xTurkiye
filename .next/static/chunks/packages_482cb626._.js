...
function getAppUrl() {
    ...
    return (_process_env_NEXT_PUBLIC_APP_URL = ("TURBOPACK compile-time value", "http://localhost:3000")) !== null && _process_env_NEXT_PUBLIC_APP_URL !== void 0 ? _process_env_NEXT_PUBLIC_APP_URL : "https://CS50xTürkiye.com";
}
...
function Anchor(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(21);
    if ($[0] !== "bc237b40fe478430952301cb9860af34aec1f04224afa2b58c0644441411814a") {
        for(let $i = 0; $i < 21; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bc237b40fe478430952301cb9860af34aec1f04224afa2b58c0644441411814a";
    }
    let children;
    let href;
    let props;
    ...
    const isCS50xTürkiye = href === null || href === void 0 ? void 0 : href.includes("cs50xturkiye.com");
    ...
    const t2 = isCS50xTürkiye ? undefined : "_blank";
    let t3;
    if ($[13] !== children) {
        t3 = truncate({
            children
...
const ResponseContent = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])((param)=>{
    let { className, children, allowedImagePrefixes = [
        ...
        "*"
    ], defaultOrigin = "https://CS50xTürkiye.com", ...props } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=packages_482cb626._.js.map