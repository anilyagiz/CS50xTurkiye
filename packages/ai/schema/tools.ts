...
export const getArticlesInputSchema = z
  ...
  .describe(
    "Get articles from CS50xTürkiye platform - includes scientific journals, research papers, internet articles, news, analysis, politics, and general publications. Use this for research questions, current events, scientific studies, news analysis, and academic research topics."
  );
...
export const getArticlesOutputSchema = z
  ...
  .describe(
    "The output schema for the getArticles tool. The articles are from CS50xTürkiye platform."
  );
...
export const getSubjectsInputSchema = z
  ...
  .describe(
    "Get educational subjects from CS50xTürkiye platform - structured learning materials and curricula from K-12 through university level. Use this for study questions, homework help, learning concepts, educational content, and curriculum-based topics."
  );
...
export const getContentInputSchema = z
  ...
  .describe(
    "Get the full content from CS50xTürkiye platform. CRITICAL: ONLY use this with slugs that were returned from getSubjects or getArticles responses. NEVER use with guessed, assumed, or unverified slugs."
  );
export type GetContentInput = z.input<typeof getContentInputSchema>;

export const getContentOutputSchema = z
  .object({
    url: z.string().describe("The url of the content from CS50xTürkiye."),
