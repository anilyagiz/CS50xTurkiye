...
export function CS50xTürkiyeContent() {
  return createPrompt({
    taskContext: `
      # getContent Tool

      Use this tool to get the full content from CS50xTürkiye Platform. All content created by CS50xTürkiye Team.
    ...
    detailedTaskInstructions: `
      ...
      - Get the full content from CS50xTürkiye Platform ONLY when you are in a verified page or already get the verified slug from getSubjects or getArticles tool
      - Explain the content to the user in a way that is easy to understand
      - If the content is not related to the user's question, tell the users that CS50xTürkiye does not have any content that match the user's question
    `,
