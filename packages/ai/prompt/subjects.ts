...
export function CS50xTürkiyeSubjects() {
  return createPrompt({
    taskContext: `
      # getSubjects Tool

      Use this tool to get list of subjects from CS50xTürkiye Platform. All subjects are about K-12 to university level created by CS50xTürkiye Team.
    ...
    toolUsageGuidelines: `
      ...
      2. The user asks to find subjects from CS50xTürkiye Platform  
      ...
      1. The user asks to find subjects from CS50xTürkiye Platform but you already have the list of subjects
      2. The user asks up to date or current events or scientific research that not related to CS50xTürkiye's subjects category, grade, or material
    ...
    detailedTaskInstructions: `
      ...
      - Get the list of subjects from CS50xTürkiye Platform before using getContent tool or when user asks to find subjects from CS50xTürkiye Platform
      ...
      - If list returned is empty, tell the users that CS50xTürkiye does not have any subjects that match the user's question
    `,
    ...
    examples: `
      ...
      <example>
        ...
        Assistant: Sure, I'll get the subjects from CS50xTürkiye for you.
    ...
    finalRequest: `
      ...
      Use getSubjects tool when you are in a page where the slug contains \`subject\` and the user asks to find subjects from CS50xTürkiye Platform.
