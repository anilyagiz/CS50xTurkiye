...
export function CS50xTürkiyeWebSearch() {
  return createPrompt({
    taskContext: `
      # webSearch Tool

      Use this tool to search the web for up-to-date information and as universal fallback for ANY topic when CS50xTürkiye content is insufficient.
    ...
    toolUsageGuidelines: `
      ...
      1. You have enough information from CS50xTürkiye content, typically from getContent tool
